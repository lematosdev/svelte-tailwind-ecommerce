  ...
  <div class="p-2">
    ...
    <div>
      ...
      <div class="flex flex-row mt-2">
        ...
        <div
          class="text-lg text-right flex-grow justify-end mt-1 mr-4 font-bold"
        >
          ${product.price}
        </div>
        <div>
          <span class="z-10 absolute flex items-center justify-center w-10 pt-2.5">
            <svg
          ...
          <button
            class="text-lg pl-8 pr-4 py-1 font-bold bg-indigo-500 text-white rounded-full"
            >ADD TO CART</button
          >
        </div>
      </div>
